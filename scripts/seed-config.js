...
const ParentBlock =
  models.ParentBlock || model('ParentBlock', parentBlockSchema);
...
const sitDepartments = [
  ...
  { code: 'TA', name: 'Tamil' },
  {
    ...
    eventIdTemplate: 'CLGYEARMMESBYY',
  },
];
...
const professionalSocieties = [
  {
    ...
    eventIdTemplate: 'CLGYEARMMSTEYY',
  },
  {
    code: 'IEI',
    name: 'Institution of Engineers (India)',
    eventIdTemplate: 'CLGYEARMMSIEYY',
  },
  {
    code: 'CSI',
    name: 'Computer Society of India (CSI)',
    eventIdTemplate: 'CLGYEARMMSCSYY',
  },
  { code: 'SAE', name: 'SAE' },
  ...
  {
    code: 'ICI',
    name: 'Indian Concrete Institute(ICI)',
    eventIdTemplate: 'CLGYEARMMSICYY',
  },
  {
    code: 'IIC',
    name: 'Institution Innovation Council',
    eventIdTemplate: 'CLGYEARMMIICYY',
  },
  {
    code: 'ITS',
    name: 'Information Theory Society (ITS)',
    eventIdTemplate: 'CLGYEARMMSITYY',
  },
  {
    code: 'IGB',
    name: 'Indian Green Building Council (IGB)',
    eventIdTemplate: 'CLGYEARMMSGBYY',
  },
  {
    code: 'MTS',
    name: 'Marine Technology (MTS)',
    eventIdTemplate: 'CLGYEARMMSMTYY',
  },
  { code: 'ISHRAE', name: 'ISHRAE', eventIdTemplate: 'CLGYEARMMSHRYY' },
  {
    code: 'IWS',
    name: 'Indian Welding Society (IWS)',
    eventIdTemplate: 'CLGYEARMMSIWYY',
  },
  {
    code: 'ASI',
    name: 'Analytics society of India (ASI)',
    eventIdTemplate: 'CLGYEARMMSASYY',
  },
  {
    code: 'MMA',
    name: 'Madras Management Associations (MMA)',
    eventIdTemplate: 'CLGYEARMMSMAYY',
  },
  {
    code: 'AIMS',
    name: 'Associations of Indian Management Schools (AIMS)',
    eventIdTemplate: 'CLGYEARMMSIMYY',
  },
];
...
const ieeeSocieties = [
  {
    code: 'Computer Society',
    name: 'Computer Society',
    eventIdTemplate: 'CLGYEARMMECSYY',
  },
  {
    code: 'Communications Society',
    name: 'Communications Society',
    eventIdTemplate: 'CLGYEARMMECMYY',
  },
  {
    code: 'Signal Processing Society',
    name: 'Signal Processing Society',
    eventIdTemplate: 'CLGYEARMMESPYY',
  },
  {
    code: 'Power & Energy Society',
    name: 'Power & Energy Society',
    eventIdTemplate: 'CLGYEARMMEPEYY',
  },
  {
    code: 'Robotics and Automation Society',
    name: 'Robotics and Automation Society',
    eventIdTemplate: 'CLGYEARMMERAYY',
  },
  {
    code: 'Control Systems Society',
    name: 'Control Systems Society',
    eventIdTemplate: 'CLGYEARMMECOYY',
  },
  {
    code: 'Industry Applications Society',
    name: 'Industry Applications Society',
    eventIdTemplate: 'CLGYEARMMEIAYY',
  },
  {
    code: 'Electron Devices Society',
    name: 'Electron Devices Society',
    eventIdTemplate: 'CLGYEARMMEEDYY',
  },
  {
    code: 'Circuits and Systems Society',
    name: 'Circuits and Systems Society',
    eventIdTemplate: 'CLGYEARMMECRYY',
  },
  {
    code: 'Engineering in Medicine and Biology Society',
    name: 'Engineering in Medicine and Biology Society',
    eventIdTemplate: 'CLGYEARMMEMBYY',
  },
  {
    code: 'Photonics Society',
    name: 'Photonics Society',
    eventIdTemplate: 'CLGYEARMMEPSYY',
  },
  {
    code: 'Vehicular Technology Society',
    name: 'Vehicular Technology Society',
    eventIdTemplate: 'CLGYEARMMEVTYY',
  },
  {
    code: 'Aerospace and Electronic Systems Society',
    name: 'Aerospace and Electronic Systems Society',
    eventIdTemplate: 'CLGYEARMMEAEYY',
  },
  {
    code: 'Education Society',
    name: 'Education Society',
    eventIdTemplate: 'CLGYEARMMEESYY',
  },
  {
    code: 'Women in Engineering',
    name: 'Women in Engineering',
    eventIdTemplate: 'CLGYEARMMEWEYY',
  },
...
const clubs = [
  {
    code: 'Technoculture Club',
    name: 'Technoculture Club',
    eventIdTemplate: 'CLGYEARMMCTCYY',
  },
  {
    code: 'Automobile Club',
    name: 'Automobile Club',
    eventIdTemplate: 'CLGYEARMMCAMYY',
  },
  ...
  {
    code: 'Disaster Management & Safety Club',
    name: 'Disaster Management & Safety Club',
    eventIdTemplate: 'CLGYEARMMCDSYY',
  },
  {
    code: 'Eco and Swacch Bharat',
    name: 'ECO and Swacch Bharat',
    eventIdTemplate: 'CLGYEARMMCESYY',
  },
  { code: 'ENSAV Club', name: 'ENSAV Club', eventIdTemplate: 'CLGYEARMMCENYY' },
  {
    code: 'English Literary Club',
    name: 'English Language & Literature club',
    eventIdTemplate: 'CLGYEARMMCELYY',
  },
  {
    code: 'Foreign Language Club',
    name: 'Foreign Language Club',
    eventIdTemplate: 'CLGYEARMMCFLYY',
  },
  {
    code: 'Fine Arts Association',
    name: 'Fine arts Association',
    eventIdTemplate: 'CLGYEARMMCFAYY',
  },
  {
    code: 'Health & Yoga Club',
    name: 'Health & Yoga Club',
    eventIdTemplate: 'CLGYEARMMCHYYY',
  },
  {
    code: 'M-apps Club',
    name: 'M-apps Club',
    eventIdTemplate: 'CLGYEARMMCMAYY',
  },
  { code: 'Maths Club', name: 'Maths Club', eventIdTemplate: 'CLGYEARMMCMTYY' },
  {
    code: 'Photography Club',
    name: 'Photography Club',
    eventIdTemplate: 'CLGYEARMMCPHYY',
  },
  {
    code: 'Robotics Club',
    name: 'Robotics Club',
    eventIdTemplate: 'CLGYEARMMCRBYY',
  },
  {
    code: 'Rotaract Club',
    name: 'Rotaract Club',
    eventIdTemplate: 'CLGYEARMMCRTYY',
  },
  {
    code: 'Science club',
    name: 'Science club',
    eventIdTemplate: 'CLGYEARMMCSCYY',
  },
  {
    code: 'Skill development Club',
    name: 'Skill development Club',
    eventIdTemplate: 'CLGYEARMMCSDYY',
  },
  {
    code: 'Sai Muthamizh Mandram',
    name: 'Sai Muthamizh Mandram',
    eventIdTemplate: 'CLGYEARMMCMMYY',
  },
  {
    code: 'Young Indians Club',
    name: 'Young Indians Club(YUVA)',
    eventIdTemplate: 'CLGYEARMMCYUYY',
  },
  {
    code: 'Red Ribbon Club',
    name: 'Red Ribbon Club',
    eventIdTemplate: 'CLGYEARMMCRRYY',
  },
  {
    code: 'Game Development Club',
    name: 'Game Development Club',
    eventIdTemplate: 'CLGYEARMMCGDYY',
  },
  {
    code: 'Artificial Intelligence and Machine Learning Club',
    name: 'Artificial Intelligence and Machine Learning Club',
    eventIdTemplate: 'CLGYEARMMCMLYY',
  },
  {
    code: 'Entrepreneurship Cell',
    name: 'Entrepreneurship Cell',
    eventIdTemplate: 'CLGYEARMMCECYY',
  },
  {
    code: 'Higher Education Cell',
    name: 'Higher Education Cell',
    eventIdTemplate: 'CLGYEARMMCHEYY',
  },
  { code: 'NCC', name: 'NCC', eventIdTemplate: 'CLGYEARMMNCCYY' },
  { code: 'NSS', name: 'NSS', eventIdTemplate: 'CLGYEARMMNSSYY' },
  {
    code: 'Wowww',
    name: 'Women Empowerment Cell (WOWWW)',
    eventIdTemplate: 'CLGYEARMMCWEYY',
  },
  ...
  { code: 'IPR', name: 'IPR', eventIdTemplate: 'CLGYEARMMIPRYY' },
  {
    ...
    eventIdTemplate: 'CLGYEARMMCGOYY',
  },
...
async function seedClubs() {
  ...
  for (const c of clubs) {
    ...
    console.log(
      `  ✓ ${c.code.substring(0, 30)} (${c.eventIdTemplate || 'no template'})`
    );
  }
}
