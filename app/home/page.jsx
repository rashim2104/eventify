            ...
            {[
              {
                ...
                description:
                  'Submit detailed event proposals using smart forms.',
              },
              {
                step: '2',
                title: 'Book Venue',
                description:
                  'Check availability and reserve venues for your dates.',
              },
              {
                step: '3',
              ...
              },
              {
                ...
                title: 'Conduct Event',
                description:
                  'Execute event and submit post-event documentation.',
              },
              {
                step: '5',
                title: 'Generate Reports',
                description:
                  'Create comprehensive event reports and analytics.',
              },
            ].map((step, index) => (
              <div
                key={index}
