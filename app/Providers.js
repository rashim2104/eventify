...
const convertOklchToHex = oklchValue => {
  const oklchMap = {
    'oklch(0.205 0 0)': '#1a1a1a',
    'oklch(0.97 0 0)': '#f7f7f7',
    'oklch(0.577 0.245 27.325)': '#ef4444',
    'oklch(0.646 0.222 41.116)': '#10b981',
    'oklch(0.6 0.118 184.704)': '#3b82f6',
    'oklch(0.398 0.07 227.392)': '#8b5cf6',
  ...
  return oklchMap[oklchValue] || '#6366f1';
};
...
const theme = createTheme({
  ...
  components: {
    ...
    MuiChip: {
      styleOverrides: {
        root: { borderRadius: 'calc(var(--radius) / 2)' },
      },
    },
    MuiAppBar: {
      styleOverrides: {
...
// Theme-only provider for public pages (no auth)
...
// Full providers including session for authenticated pages
