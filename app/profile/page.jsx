          ...
          {newPassword.length > 0 && (
            <div className="mb-4">
              ...
              <ul className="mt-2 text-sm space-y-1">
                <li className={requirements.length ? 'text-green-600' : 'text-gray-600'}>
                  ✓ At least 8 characters
                </li>
                <li className={requirements.lowercase ? 'text-green-600' : 'text-gray-600'}>
                  ✓ One lowercase letter
                </li>
                <li className={requirements.uppercase ? 'text-green-600' : 'text-gray-600'}>
                  ✓ One uppercase letter
                </li>
                <li className={requirements.number ? 'text-green-600' : 'text-gray-600'}>
                  ✓ One number
                </li>
                <li className={requirements.special ? 'text-green-600' : 'text-gray-600'}>
